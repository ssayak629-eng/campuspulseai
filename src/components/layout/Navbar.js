            ...
            >
                ...
                >
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginLeft: "auto" }}>
                        ...
                        {/* Create Event */}
                        <Link href="/events/create" className="btn-primary" style={{ fontSize: "0.85rem", padding: "0.45rem 1rem", textDecoration: "none" }}>
                            + Create Event
                        </Link>
                        ...
                        {navLinks.map(({ href, label, icon: Icon }) => (
                            <Link
                                ...
                                style={{
                                    ...
                                    textDecoration: "none",
                                    color:
                                        pathname.startsWith(href) ? "#a5b4fc" : "var(--text-secondary)",
                                    background: pathname.startsWith(href)
                                        ? "rgba(99,102,241,0.1)"
                                        : "transparent",
